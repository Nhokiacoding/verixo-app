  ...
  welcome: {
    ...
    html: (userData) => `
      ...
      <body>
        <div class="container">
          <div class="header">
            <img src="https://your-domain.com/images/logo.png" alt="VirtNum Logo" class="logo">
  ...
  passwordReset: {
    ...
    html: (resetData) => `
      ...
      <body>
        <div class="container">
          <div class="header">
            <img src="https://your-domain.com/images/logo.png" alt="VirtNum Logo" style="height: 60px; margin-bottom: 20px;">
